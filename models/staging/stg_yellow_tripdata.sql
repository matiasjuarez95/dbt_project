...
select
   -- identifiers
    {{ dbt_utils.generate_surrogate_key(['vendor_id', 'pickup_datetime']) }} as sk_trip_id,    
    ...
    coalesce({{ dbt.safe_cast("payment_type", api.Column.translate_type("integer")) }}) as payment_type,
